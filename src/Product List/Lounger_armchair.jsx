    ...
    />
      ...
      >
        Add to Cart
          ...
          <Link to = "https://www.vectary.com/viewer/v1/?model=078d7a16-8cf3-427f-b547-b2106a2043f9&env=studio3" target = "_blank" className="inline-block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Try it Now!!</Link>
          </div>
