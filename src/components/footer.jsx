      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="footer-col-4">
          ...
          <ul className="flex space-x-4">
            ...
            <li><Link to="https://www.instagram.com/riyag4334/" target="_blank" rel="noopener noreferrer" className="text-4xl text-gray-500 hover:text-white transition"><i className="fa fa-instagram"></i></Link></li>
