        ...
        <div className="container mx-auto py-12">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="mt-8 bg-yellow-100 rounded-lg p-6">
              ...
              <p className="text-base leading-relaxed text-gray-700">
                Have questions or need assistance? Feel free to reach out to us. You can contact our customer support team via email at <span className="font-semibold">riyag4334@gmail.com</span> or give us a call at <span className="font-semibold">9528758434</span>.
              </p>
            </div>
          </div>
        </div>
